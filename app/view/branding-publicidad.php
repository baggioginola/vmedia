    ...
    <div class="moduletable  padding center">
        <div class="module_container">
            <div class="parallax parallax__ padding center"
                 data-url="<?php echo IMAGES; ?>categorias/publicidad.jpg"
                 data-speed="0.8"
                 data-direction="true"
                 data-mobile="true"
                 data-blur="false">
                            ...
                            <div class="moduletable span12">
                                <div class="row-fluid">
                                    <div class="moduletable center  span6" style="padding-bottom: 50px;">
                                        ...
                                        <img src="<?php echo IMAGES; ?>iconos/publicidad.png">
                                    </div>
                                    ...
                                    <div class="moduletable center  span6" style="padding-bottom: 50px;">
                                        <div class="item_introtext"
                                            ...
                                            <ul>
                                                <li>Creación de marcas</li>
                                                <li>Refresh de identidad e imagen corporativa</li>
